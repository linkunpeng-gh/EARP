...
TENANT_TABLE_COUNT = 44  # 0018 tbox_changes + 0019 eval 4 表 + 0025 import_rules + 0026 flow_runs（RLS 三件套）  # baseline(24) + 0005(2) + 0006(1) + 0008(7 ontology) + 0009(2 model) + 0014(1 chat_apps)
