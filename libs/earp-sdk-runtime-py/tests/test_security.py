...
class TestJWTBearerHeaderPropagation:
    ...
    async def test_create_session_carries_auth_header(self):
        ...
        await client.create_session(user_id="u1", tenant_id="t1", role_id="r1")
    ...
    async def test_invoke_carries_auth_header(self):
        ...
        session = await client.create_session(user_id="u1", tenant_id="t1", role_id="r1")
    ...
    async def test_call_shortcut_carries_auth_header(self):
        ...
        await client.call("ping", {"msg": "hi"}, user_id="u1", tenant_id="t1", role_id="r1")
        assert captured.get("authorization") == f"Bearer {self.JWT_TOKEN}", (
    ...
    async def test_set_tenant_id_persists(self):
        ...
        session = await client.create_session(user_id="u1", role_id="r1")
...
class TestJWTNoTokenNoAuthHeader:
    ...
    async def test_no_auth_header_without_token(self):
        ...
        await rc.create_session(user_id="u1", tenant_id="t1", role_id="r1")
