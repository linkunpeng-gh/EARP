...
| **F2** | **flow 执行器：DAG JSON → workflow_dsl 编译 → 对话节点适配层（LLM/Knowledge/Chat History/Condition 最小集）** ✅ **已完成 (2026-08-20)**——见 `tasks/chatflow-f2-flow-executor-task-breakdown.md` | F1 |
